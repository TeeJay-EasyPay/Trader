...
export const styles = StyleSheet.create({
  ...
  greetingCard: { backgroundColor: palette.greeting, borderColor: palette.greetingBorder, overflow: 'hidden', minHeight: 148, padding: 0 },
  greetingContent: { padding: 20, minHeight: 148 },
