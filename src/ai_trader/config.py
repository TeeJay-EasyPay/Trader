...
class Settings:
    ...
    # Proposal evaluation is query-heavy and is not a protection loop. Keep it separate
    # from auto_execution_interval_seconds, which also drives managed-exit protection.
